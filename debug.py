# In order to run the code directly for debug, I will need to run python svtool/__main__py directly.
# Unfortunately, it will cause error:
#   File "svtool/__main__.py", line 7, in <module>
...
from svtool.__main__ import main
